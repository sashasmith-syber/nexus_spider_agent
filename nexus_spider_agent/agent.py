...
class NexusSpiderAgent:
    ...
    def process_command(
        ...
        """
        result = {"command": command, "success": False, "message": "", "query": None, "results": None}
    ...
    def execute_query(self, query: str) -> Dict[str, Any]:
        ...
        """
        result = {"query": query, "success": False, "message": "", "results": None}
    ...
    def interpret_command(self, command: str) -> Optional[Dict[str, Any]]:
        ...
        """
        context = {"tables": self.list_tables(), "database": self.db_manager.db_path}
