...
Available Commands:
  ...
  - /execute  - Execute a SQL query directly
  - /schema [table] - Show database schema (optionally for specific table)
  - /tables - List all tables in the database
  - /info  - Show detailed information about a table
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Nexus Spider Agent - Privacy-focused database assistant")
    parser.add_argument(
        "--db",
        default="database.db",
